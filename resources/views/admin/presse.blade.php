...
<div class="my-3 bg-body rounded shadow-sm">
    ...
    <a href="">
        <h3 class="border-botton pb-2 mb-4"><button type="button" class="btn btn-primary">ajouter une nouvelle
                presse</button>
        </h3>
    </a>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="representant" class="form-control" name="representant">
                        </div>
                    </div>
                </div>
