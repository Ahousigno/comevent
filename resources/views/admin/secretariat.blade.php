                                ...
                                <table class="table table-bordered" id="table" data-toggle="table" id="table">
                                    ...
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <th scope="col" data-field="name" data-editable="true">Rôle au cours de
                                                l'évennement</th>
                                            <th scope="col" data-field="name" data-editable="true">état du courier</th>
                                                ...
                                                <div class="columns columns-right btn-group pull-right">
                                                    <a
                                                        ...
                                                        <button type="button" class="btn btn-success"
                                                            onclick="if(confirm('vous êtes entrain de valider cet évènement. cliquez ok pour avertir vos collaborateurs')){document.getElementById('secretariat').submit()}">Valider</button></a>
                                                    ...
                                                    <button type="button" class="btn btn-danger"
                                                        onclick="if(confirm('Voulez-vous vraiment supprimer cet évènement?')){document.getElementById('form-{{$courrier->id}}').submit()}">Supprimer</button>
                                                </div>
