...
<div class="my-3 bg-body rounded shadow-sm">
    ...
    <form role="form" action="{{route('secretariat.store')}}" enctype="multipart/form-data" method="POST">@csrf <div
            style="border:1px solid #d9ccd5; padding:5px; background:#e3c5e5" class="row">
            <div class="col-lg-12">
                <h3 class="text-blue color-uvci" style="text-align:center">Secrétariat</h3></br>
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group"><label for="nom">Nom et prénom de l'invité<span
                                    style="color: red;"></span></label>
                            <input type="text" id="nom_invite" class="form-control" name="nom_invite">
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group"><label for="prenom">fonction de l'invité<span
                                    style="color: red;"></span></label>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group"><select class="form-select" aria-label="Default select example"
                                type="text" name="role">
                                <option selected>rôle au cours de l'évènement</option>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group"><label for="prenom">charger le courrier<span
                                        style="color: red;"></span></label><input type="file" id="courier"
                                    class="form-control" name="courier"></div>
                        </div>
                    </div></br></br></br></br><button type="submit" class="btn btn-primary"
                        style="width:45%; background:#951b81; ">Envoyer pour validation </button>
                </div>
            </div>
    </form></br></br></form>
</div></br></br>
            ...
            <div class="">
                <div class="col-lg12"><br><br>
                    <h6><img style="width:17px" src="http://www.uvci.edu.ci/fr/images/EBA/googlemaps.png" alt="">Adresse
                        Géographique : Abidjan Cocody Deux-Plateaux,
                    ...
                    <div class="col-lg-6">
                        <div style="padding-top:15px" align="left" class=""><a href="https://www.facebook.com/uvciv/"
                                ...
                                href="http://uvci.tv/" title="UVCI TV" target="_blank"><img
                                    src="https://rh.uvci.edu.ci/drhuvci/public/template/webtvuvci.png" alt=""></a></div>
                    </div>
                </div>
            </div>
        </div>
