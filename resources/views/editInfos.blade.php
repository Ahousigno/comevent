    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <form role="form" action="{{route('infos.update', ['avant'=>$avant->id])}}" method="POST">
                    @csrf
                ...
                <!-- <div class="col-lg-6">
                            <div class="row">
                                ...
                                <div class="col-lg-5"><span style="color:red">*</span></label>nom de
                                    l'évènement</div>
                                <div class="col-lg-7"><input type="text" class="form-control-perso" name="nom_event">
                                </div>
                                </br> </br>
                                <div class="col-lg-5"><span style="color:red">* </span></label>thème de
                                    l'évènement</div>
                                <div class="col-lg-7"><input type="text" class="form-control-perso" name="theme"></div>
                                </br> </br>
                                <div class="col-lg-5"><span style="color:red">* </span></label>thème de
                                    réference de l'évènement(TDR)</div>
                                <div class="col-lg-7"><input type="file" class="form-control-perso" name="tdr" value="">
                                </div>
                                </br> </br>
                                ...
                                <div class="col-lg-5"><span style="color:red">* </span></label>budget</div>
                                <div class="col-lg-7"><input type="number" class="form-control-perso" name="budget"
                                        value=""></div>
                                </br> </br>
                                <div class="col-lg-5"><span style="color:red">* </span></label>Date de
                                    l'évènement</div>
                                <div class="col-lg-7"><input type="date" class="form-control-perso" name="date"
                                        value=""></div>
                                </br> </br>
                                <div class="col-lg-5"><span style="color:red">* </span></label>Lieu de
                                    l'évènement</div>
                                <div class="col-lg-7"><input type="text" class="form-control-perso" name="lieu"
                                        value=""></div>
                                </br> </br>
                                <div class="col-lg-5"><span style="color:red"></span></label>catégorie de
                                    l'évènement</div>
                                <div class="col-lg-7">
                                    <select class="form-control-perso custom-select-perso" name="cathegorie">
                                ...
                                <div class="col-lg-5"><span style="color:red"></span></label>portée de
                                    l'évènement</div>
                                <div class="col-lg-7">
                                    <select class="form-control-perso custom-select-perso" name="portee">
                                        <option selected value="">---- Selectionnez ---</option>
                                        <option value="UVCI">UVCI</option>
                                ...
                                <div class="col-lg-7"><input type="file" class="form-control-perso" name="visuel"
                                        value=""></div>
                                </br> </br>

                                <div class="col-lg-5">fichier psd du visuel</div>
                                <div class="col-lg-7"><input type="file" class="form-control-perso" name="psd" value="">
                                </div>
                                </br> </br>
                                <div class="col-lg-5">Banderole</div>
                                <div class="col-lg-7"><input type="file" class="form-control-perso" name="banderole"
                                        value=""></div>
                                </br> </br>
                                <div class="col-lg-5">fichier PSD </div>
                                <div class="col-lg-7"><input type="file" class="form-control-perso" name="psdo"
                                        value=""></div>
                                </br> </br>
                                <div class="col-lg-5">Courier</div>
                                <div class="col-lg-7"><input type="file" class="form-control-perso" name="courier"
                                        value=""></div>
                                </br></br>
                                ...
                                <div style="text-align:right" class="col-lg-6 form-group article">
                                    <input type="button" class="add-article" value="Ajouter un destinataire">
                                    <button style="font-size:10px; border-radius:2px" type="button"
                                                    class="delete-emploi btn-danger">Supprimer un destinataire</button>
                                </div>
                            </div>
                        </div> -->
                                ...
                                <div class="col-lg-9">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7"><input type="text" class="form-control-perso"
                                                name="nom_organisateur" value=""></div>
                                        </br></br>

                                        <div class="col-lg-5">prenoms </div>
                                        <div class="col-lg-7"><input type="text" class="form-control-perso"
                                                name="prenoms" value=""></div>
                                        </br></br>

                                        <div class="col-lg-5">fonction </div>
                                        <div class="col-lg-7"><input type="text" class="form-control-perso"
                                                name="fonction_organisateur" value=""></div>
                                        </br></br>

                                        <div class="col-lg-5">contact </div>
                                        <div class="col-lg-7"><input type="text" class="form-control-perso"
                                                name="contact_organisateur" value=""></div>
                                        </br></br>

                                        <div class="col-lg-5">mail </div>
                                        <div class="col-lg-7"><input type="email" class="form-control-perso"
                                                name="email_organisateur" value=""></div>
                                        </br></br>
                                        <div class="col-lg-5">nombre de réunions </div>
                                        <div class="col-lg-7"><input type="number" class="form-control-perso"
                                                name="reunion" value=""></div>
                                        </br></br>
                                        <div class="col-lg-5">compte rendu </div>
                                        <div class="col-lg-7"><input type="file" class="form-control-perso" name="cr"
                                                value=""></div>
                                        </br></br>
                                    </div>
                                </div></br></br>
                                <div style="text-align:right" class="col-lg-6 form-group article">
                                    <input type="button" class="add-article" value="Ajouter un membre">
                                    <button style="font-size:10px; border-radius:2px" type="button"
