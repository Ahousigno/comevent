...
<form role="form" action="{{route('logistique.update', ['logistique'=>$logistique->id])}}" method="POST">
    @csrf
                ...
                <div class="row">
                    <div class="col-sm-6" style="background-color: white;">
                        <div class="form-group">
                            ...
                            <input class="form-check-input" type="checkbox" id="salle" name="salle"
                                value="{{$logistique->salle}}">
                            <label class=" form-check-label" for="flexCheckDefault">
                                AULA
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="{{$logistique->chaise}}" id="chaise"
                                checked name="chaise">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="" id="salle" name="salle">
                            <label class="form-check-label" for="flexCheckChecked">
                                Salle de Conférence
                            </label>
                        </div>
