...
<body>
    ...
    <div class="all-content-wrapper">
        ...
        <div class="header-advance-area" ;">
            <div class="header-top-area" style="background-color: purple;">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="col-lg-6 col-md-7 col-sm-6 col-xs-12">
                                        <div class="header-top-menu tabl-d-n">
                                            <ul class="nav navbar-nav mai-top-nav">
                                                ...
                                                <li class="nav-item"><a href="#" class="{{route('infos')}}">Avant</a>
                                                </li>
                                                <li class="nav-item"><a href="#" class="{{route('apres')}}">Après</a>
                                                </li>
                                ...
                                <ul class="mobile-menu-nav">
                                    ...
                                    <li><a data-toggle="collapse" data-target="#demoevent" href="#">Professors <span
                                        ...
                                        <ul id="demoevent" class="collapse dropdown-header-top">
                                            <li><a href="all-professors.html">All
                                                    Professors</a>
                                            </li>
                                            <li><a href="add-professor.html">Add
                                                    Professor</a>
                                            </li>
                                            <li><a href="edit-professor.html">Edit
                                                    Professor</a>
                                            </li>
                                    ...
                                    <li><a data-toggle="collapse" data-target="#demopro" href="#">Students <span
                                        ...
                                        <ul id="demopro" class="collapse dropdown-header-top">
                                            ...
                                            <li><a href="student-profile.html">Student
                                                    Profile</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li><a data-toggle="collapse" data-target="#democrou" href="#">Courses <span
                                        ...
                                        <ul id="democrou" class="collapse dropdown-header-top">
                                            ...
                                            <li><a href="course-profile.html">Courses
                                                    Info</a>
                                            </li>
                                            <li><a href="course-payment.html">Courses
                                                    Payment</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li><a data-toggle="collapse" data-target="#demolibra" href="#">Library <span
                                        ...
                                        <ul id="demolibra" class="collapse dropdown-header-top">
                                            <li><a href="library-assets.html">Library
                                                    Assets</a>
                                            </li>
                                            <li><a href="add-library-assets.html">Add
                                                    Library Asset</a>
                                            </li>
                                            <li><a href="edit-library-assets.html">Edit
                                                    Library Asset</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li><a data-toggle="collapse" data-target="#demodepart" href="#">Departments
                                        ...
                                        <ul id="demodepart" class="collapse dropdown-header-top">
                                            <li><a href="departments.html">Departments
                                                    List</a>
                                            </li>
                                            <li><a href="add-department.html">Add
                                                    Departments</a>
                                            </li>
                                            <li><a href="edit-department.html">Edit
                                                    Departments</a>
                                            </li>
                                        </ul>
                                    </li>
