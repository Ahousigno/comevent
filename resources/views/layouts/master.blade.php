...
<body class="bg-light">
    ...
    <nav class="navbar navbar-expand-lg fixed-top navbar-dark" aria-label="Main navigation"  id="nav-bar">
        <div class="container-fluid">
            ...
            <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefaul">
                <ul class="navbar-nav">
                    <li class="nav-item" style="margin-right: 60px">
                        <img class="me-3" src="img/logo.png" alt="" width="68" height="58">
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="http://127.0.0.1:8000/" id="nav-link">Accueil</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="{{route('infos')}}" id="nav-link">Soumettre un évènement</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="{{route('apres')}}" id="nav-link">Après</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="{{route('apres')}}" id="nav-link">Archive</a>
                    </li>
                    <!--
                    <form class="d-flex">
                    ...
                    <li class="nav-item" style="margin-left: 500px">
                        ...
                        <a class="nav-link" href="{{route('login')}}" id="nav-link">Connexion</a>
                    </li>
                    {{--<li class="nav-item">
